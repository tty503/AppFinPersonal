...
class Program
{
    ...
    private static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddAutoMapper(typeof(AccountApplication.Queries.GetAllAccount).Assembly);
        services.AddAutoMapper(typeof(AccountApplication.Queries.GetOneAccount).Assembly);
    ...
    private static void ConfigureExceptionHandling(IServiceCollection services, IConfiguration configuration)
    {
        ...
        catch (MySqlException ex)
        {
            ...
            {
                services.AddSingleton<ILogger<AccountContext>>((provider) =>
                {
                    var logger = provider.GetRequiredService<ILoggerFactory>().CreateLogger<AccountContext>();
